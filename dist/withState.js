...
var withState = function withState(stateName, stateUpdaterName, initialState) {
  return function (BaseComponent) {
    ...
    var StatedComponent = (_temp =
    /*#__PURE__*/
    function (_Component) {
      _inherits(StatedComponent, _Component);
      ...
      function StatedComponent() {
        ...
        _classCallCheck(this, StatedComponent);

        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }

        _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(StatedComponent)).call.apply(_getPrototypeOf2, [this].concat(args)));
...
var _default = (0, _createHelper.default)(withState, 'withState');
