 ...
 * @returns {Function}
 */
var _default = function _default(propName) {
  return function (Component) {
    return function (props) {
      var newProps = props[propName] && _typeof(props[propName]) === 'object' ? _objectSpread({}, props, props[propName]) : _objectSpread({}, props);
